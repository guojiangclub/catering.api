...
class ClerkController extends Controller
{
	...
	public function update($clerk_id)
	{
		...
		$rules   = [
			...
			'email'                 => "unique:st_clerk,email,$clerk_id|email",
			'clerk_no'              => "unique:st_clerk,clerk_no,$clerk_id",
			'mobile'                => "required|unique:st_clerk,mobile,$clerk_id",
		];
		$message = [
	...
	public function store()
	{
		...
		$rules   = [
			...
			'password'              => 'required|confirmed',
			'password_confirmation' => 'required',
			'email'                 => "unique:st_clerk,email|email",
			'clerk_no'              => "required|unique:st_clerk,clerk_no",
			'mobile'                => "required|unique:st_clerk,mobile",
