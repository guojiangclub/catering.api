<div class="tabs-container">
    ...
    <ul class="nav nav-tabs">
            ...
            <a no-pjax href="{{route('admin.shitang.gift.new.user.create')}}" class="btn btn-w-m btn-info pull-right">添加新人进店礼</a>
        </ul>
                        ...
                        @if(count($lists)>0)
                            @foreach($lists as $item)
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-xs btn-primary" href="{{route('admin.shitang.gift.new.user.edit',$item->id)}}" no-pjax><i data-toggle="tooltip" data-placement="top" class="fa fa-pencil-square-o" title="编辑"></i></a>
                                        <span class="btn btn-xs btn-danger del-activity" data-url="{{route('admin.shitang.gift.new.user.delete',$item->id)}}"><i class="fa fa-trash" data-toggle="tooltip" data-placement="top" title="删除"></i></span>
                                    </td>
                                    <td>
                                        <a>
    ...
    <script>
        ...
        $('.switch').on('click', function () {
	        ...
	        $.post("{{route('admin.shitang.gift.new.user.toggleStatus')}}",
		        {
			        status: status,
			        id: modelId
		        },
