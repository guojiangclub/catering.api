...
<div class="form-group">
    ...
    <div class="col-sm-9">
        <label class="checkbox-inline i-checks"><input name="base[is_open]" type="radio" value="0" {{$discount->is_open == 0?'checked' : ''}}> 否</label>
        <label class="checkbox-inline i-checks"><input name="base[is_open]" type="radio" value="1" {{$discount->is_open == 1?'checked' : ''}}> 是</label>
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-9">
        <input type="text" class="form-control" name="base[effective_days]" placeholder="" value="{{$discount->effective_days}}"/>
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-9">
        <label class="checkbox-inline i-checks"><input name="base[status]" type="radio" value="1" {{$discount->status == 1?'checked' : ''}}> 启用</label>
        <label class="checkbox-inline i-checks"><input name="base[status]" type="radio" value="0" {{$discount->status == 0?'checked' : ''}}> 禁用</label>
    </div>
</div>
