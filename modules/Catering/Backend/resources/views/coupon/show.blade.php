    ...
    <div class="ibox float-e-margins">
        <div class="ibox-content" style="display: block;">
            {!! Form::open( [ 'route' => ['admin.shitang.coupon.show'], 'method' => 'get', 'id' => 'recordSearch-form','class'=>'form-horizontal'] ) !!}
            <div class="row">
                <div class="col-md-7">
                    <div class="col-sm-6">
                ...
                <div class="col-md-2">
                    <a data-toggle="modal-filter" class="btn btn-primary"
                       ...
                       data-keyboard="false"
                       data-link="{{route('admin.shitang.coupon.getCouponsExportData',['type'=>'xls'])}}"
                       id="all-xls"
    ...
    <script>
        ...
        $(document).on('click.modal.data-api', '[data-toggle="modal-filter"]', function (e) {
            ...
            var url = '{{route('admin.shitang.coupon.getCouponsExportData')}}';
