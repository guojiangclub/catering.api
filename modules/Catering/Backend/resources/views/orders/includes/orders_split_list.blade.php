                ...
                <th>
                    <table style="width: 100%">
                        <tr>
                            ...
                            <th style="width: 8%;text-align: center;">售后状态</th>
                            ...
                            <th style="width: 13%;text-align: center;">下单时间</th>
                        ...
                        <table class="table table-hover table-striped">
                            ...
                            @foreach($order as $item)
                                <tr>
                                    ...
                                    <td style="width: 10%;text-align: center;">{{$item->StatusText}}</td>
                                    <td style="width: 8%;text-align: center;">{{$item->refund_status}}</td>
                                    <td style="width: 7%;text-align: center;">{{$item->count}}</td>
                                    <td style="width: 8%;text-align: center;">{{$item->items_total}}</td>
                                    <td style="width: 7%;text-align: center;">{{$item->total}}</td>
                                    <td style="width: 13%;text-align: center;">{{$item->created_at}}</td>
                                    <td style="position: relative;width: 10%;text-align: center;">
