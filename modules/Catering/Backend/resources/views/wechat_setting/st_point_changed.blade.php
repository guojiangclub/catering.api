            ...
            <div id="tab-1" class="tab-pane active">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <i class="fa fa-info-circle"></i> 积分变更提醒
                    </div>
                    <div class="panel-body">
                        <div class="col-sm-8">
                            <div class="form-group">
                                <label class="col-sm-2 control-label">积分变更提醒</label>
                                <div class="col-lg-6">
                                    <div class="radio">
                                        <label><input type="radio" name="wechat_message_st_point_changed[status]"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="wechat_message_st_point_changed[id]"
                                           value="{{isset($point['id']) && $point['id'] ? $point['id'] : 'OPENTM202358123'}}"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="wechat_message_st_point_changed[first]"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="wechat_message_st_point_changed[template_id]"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="wechat_message_st_point_changed[remark]"
                        ...
                        <div class="col-sm-4">
                            <div class="wx-template">
                                ...
                                <div class="wx-content">
                                    ...
                                    变更类型：消费获赠500积分<br/>
                                    当前积分：500<br/><br/>
                                    <span class="wechat_message_remark_text_target">{{isset($point['remark']) && $point['remark'] ? $point['remark'] : '点击了解更多活动详情'}}</span>
                                </div>
