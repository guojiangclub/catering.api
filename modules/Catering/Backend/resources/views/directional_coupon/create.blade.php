    ...
    <div class="tab-content">
        <div id="tab-1" class="tab-pane active">
            <div class="panel-body">
                <div class="row">
                    {!! Form::open( [ 'url' => [route('admin.shitang.directional.searchUser')], 'method' => 'POST', 'id' => 'create-directional-coupon-form','class'=>'form-horizontal'] ) !!}
    ...
    function click_s(num, input) {
        swal({
                ...
                function (inputValue) {
                    ...
                    input._token = _token;
                    var url = "{{route('admin.shitang.directional.coupon.store')}}";
                    $('#alert-box').show();
                    $.post(url, input, function (ret) {
                        ...
                        if (!ret.status) {
                            ...
                            swal({
                                ...
                                location.href = "{{route('admin.shitang.directional.coupon.index')}}";
