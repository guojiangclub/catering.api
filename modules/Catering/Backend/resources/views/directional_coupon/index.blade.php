<div class="tabs-container">
    ...
    <ul class="nav nav-tabs">
        <li
                ...
                class="active"
                @endif
        ><a no-pjax href="{{route('admin.shitang.directional.coupon.index')}}" aria-expanded="true"> 定向发券活动列表</a></li>
        <li
                @if(request('status')!=null)
                class="active"
                @endif
        ><a no-pjax
            href="{{route('admin.shitang.directional.coupon.index',['status'=>0])}}" aria-expanded="true">
                已删除定向发券活动</a></li>
        <a no-pjax href="{{route('admin.shitang.directional.coupon.create')}}"
           class="btn btn-w-m btn-info pull-right">添加定向发券活动</a>
    </ul>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a target="_blank"
                                       ...
                                       href="{{route('admin.shitang.directional.edit',['id'=>$item->id])}}">
                                    ...
                                    <a
                                            class="btn btn-xs btn-primary"
                                            target="_blank"
                                            href="{{route('admin.shitang.directional.log',$item->id)}}">
                                        <i data-toggle="tooltip" data-placement="top"
                                           class="fa fa-eye"
                                           title="发送记录"></i></a>
                                    ...
                                    @if(request('status')==null)
                                        <span class="btn btn-xs btn-danger del-suit"
                                              data-url="{{route('admin.shitang.directional.delete',['id'=>$item->id])}}">
