...
namespace GuoJiangClub\Catering\AlbumBackend\Http\Controllers;

use GuoJiangClub\Catering\AlbumBackend\Models\Image;
use GuoJiangClub\Catering\AlbumBackend\Models\ImageCategory;
use GuoJiangClub\Catering\AlbumBackend\Repository\ImageRepository;
use GuoJiangClub\Catering\AlbumBackend\Repository\ImageCategoryRepository;
...
//        return view('file-manage::image.index', compact('imgList', 'categories', 'category', 'categorySub'));
	}
