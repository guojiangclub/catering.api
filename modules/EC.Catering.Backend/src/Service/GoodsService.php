...
namespace GuoJiangClub\EC\Catering\Backend\Service;
...
use GuoJiangClub\EC\Catering\Backend\Repositories\SearchSpecRepository;
use GuoJiangClub\EC\Catering\Backend\Repositories\GoodsCategoryRepository;
...
class GoodsService
{
	...
	public function __construct()
	{
		...
		$this->searchSpecRepository    = app(SearchSpecRepository::class);
	}
