...
namespace ElementVip\Store\Backend\Http\Controllers;

use ElementVip\Store\Backend\Model\CategoryGroup;
...
//        return view('catering-backend::category_group.index', compact('group'));
    }
...
//        return view('catering-backend::category_group.create');
    }
