...
class GoodsSpecController extends Controller
{
	public function index()
	{
		...
		return LaravelAdmin::content(function (Content $content) use ($specs) {
			...
			$content->body(view('catering-backend::specs.index', compact('specs')));
		});
	}
	...
	public function create()
	{
		return LaravelAdmin::content(function (Content $content) {
			...
			$content->body(view('catering-backend::specs.create'));
		});
	}
	...
	public function edit($id)
	{
		...
		return LaravelAdmin::content(function (Content $content) use ($spec) {
			...
			$content->body(view('catering-backend::specs.edit', compact('spec')));
		});
	}
	...
	public function specValue($id)
	{
		...
		return LaravelAdmin::content(function (Content $content) use ($spec, $color) {
			...
			$content->body(view('catering-backend::specs.value.edit', compact('spec', 'color')));
		});
//        return view('catering-backend::specs.value.edit', compact('spec', 'color'));
	...
	public function editSpecValue()
	{
		...
		return view('catering-backend::specs.value.edit_value', compact('specValue', 'color'));
	}
	...
	public function addSpecValue($spec_id)
	{
		...
		return view('catering-backend::specs.value.add_value', compact('spec_id', 'color'));
	}
}
