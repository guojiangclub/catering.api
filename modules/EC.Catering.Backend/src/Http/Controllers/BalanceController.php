...
use GuoJiangClub\EC\Catering\Backend\Models\Balance;
...
class BalanceController extends Controller
{
	...
	public function index()
	{
		...
		return LaravelAdmin::content(function (Content $content) use ($balances) {
			...
			$content->body(view('catering-backend::balance.index', compact('balances')));
		});
	}
	...
	{
		return view('catering-backend::balance.includes.import-balance');
	}
