<div class="nav-tabs-custom tabs-container">
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane div_3" id="tab_3">
            <div class="panel-body">
                <div class="box-body table-responsive no-padding integral">
                    @include('catering-backend::auth.includes.user-integral-list')
                </div>
            </div>
        </div>
        ...
        <div class="tab-pane" id="tab_4">
            <div class="panel-body">
                <div class="box-body table-responsive no-padding">
                    @include('catering-backend::auth.includes.user-balance-list')
                </div>
            </div>
        </div>
    </div>
...
@include('catering-backend::auth.script')
...
@include('catering-backend::auth.scripts.pointList-script')
@include('catering-backend::auth.scripts.balance-script')