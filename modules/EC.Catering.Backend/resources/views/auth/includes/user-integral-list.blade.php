<div class="col-md-12">
    <div class="col-md-4">
        线上积分：{{app('GuoJiangClub\Catering\Component\Point\Repository\PointRepository')->getSumPointValid($user->id,'default')}}
    </div>
    <div class="col-md-4">
        线下积分：{{app('GuoJiangClub\Catering\Component\Point\Repository\PointRepository')->getSumPointValid($user->id,'offline')}}
    </div>
</div>
