<div class="tabs-container">
    ...
    <ul class="nav nav-tabs">
        ...
        <li class="{{ Active::pattern('admin/member/users/banned') }}"><a
                    href="{{route('admin.users.banned')}}">禁用的会员</a>
        </li>
        ...
        <a href="{{route('admin.users.create')}}" class="btn btn-w-m btn-info pull-right"
           style="margin-right: 5px">添加会员</a>
