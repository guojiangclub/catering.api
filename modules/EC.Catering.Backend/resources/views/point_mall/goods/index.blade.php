...
@section('content')--}}
    ...
    <div class="tabs-container">
        <ul class="nav nav-tabs">
            <li class="{{ Active::query('view',0) }}"><a no-pjax  href="{{route('admin.point-mall.goods.index',['view'=>0])}}"> 上架商品
                    <span class="badge">{{$allCount}}</span></a></li>
            <li class="{{ Active::query('view',2) }}"><a no-pjax  href="{{route('admin.point-mall.goods.index',['view'=>2])}}"> 已下架商品
                    ...
                    <div class="row">
                        <div class="col-md-10">
                            ...
                            <div style="display: none" class="btn-group">
                                {{--<button  data-href="{{route('admin.goods.excel',request()->except('page'))}}"--}}
                                {{--id="export" class="ladda-button btn btn-primary">导出全部商品</button>--}}
...
@section('after-scripts-end')--}}
    ...
    @include('catering-backend::commodity.includes.script')
{{--@endsection--}}