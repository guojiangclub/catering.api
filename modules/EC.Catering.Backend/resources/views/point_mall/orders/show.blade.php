        ...
        <div class="tab-content">
            <div class="tab-pane active" id="tab_1">
                <div class="panel-body">
                    @include('catering-backend::orders.includes.order_basic')
                </div>
            ...
            <div class="tab-pane" id="tab_2">
                <div class="panel-body">
                    @include('catering-backend::orders.includes.order_address')
                </div>
            </div>

            <div class="tab-pane" id="tab_3">
                <div class="panel-body">
                    @include('catering-backend::orders.includes.order_goods')
                </div>
            </div>

            <div class="tab-pane" id="tab_4">
                <div class="panel-body">
                    @include('catering-backend::orders.includes.order_cost')
                </div>
            </div>

            <div class="tab-pane" id="tab_5">
                <div class="panel-body">
                    @include('catering-backend::orders.includes.order_invoice')
                </div>
            </div>
            ...
            <div class="tab-pane" id="tab_7">
                <div class="panel-body">
                    @include('catering-backend::orders.includes.order_comment')
                </div>
            </div>

            <div class="tab-pane" id="tab_8">
                <div class="panel-body">
                    @include('catering-backend::orders.includes.order_discount')
                </div>
            </div>

            <div class="tab-pane" id="tab_9">
                <div class="panel-body">
                    @include('catering-backend::orders.includes.order_points')
                </div>
            </div>

            <div class="tab-pane" id="tab_10">
                <div class="panel-body">
                    @include('catering-backend::orders.includes.order_refund')
                </div>
            </div>
...
{{--    @include('catering-backend::orders.includes.script')--}}
{{--@stop--}}
