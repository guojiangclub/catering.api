...
<div class="tabs-container">
    <ul class="nav nav-tabs">
        <li class="{{ Active::pattern('admin/member/balances') }}"><a
                    href="{{route('admin.users.balances.list',['name'=>request('name'),'mobile'=>request('mobile'),'stime'=>request('stime'),'etime'=>request('etime')])}}">
                会员余额记录</a></li>
    ...
    <div class="tab-content">
        <div id="tab-1" class="tab-pane active">
            <div class="panel-body">
                ...
                @include('catering-backend::balance.includes.list')
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-md-8 col-sm-12">
                        @include('catering-backend::balance.includes.search-balance')
                    </div>
                </div>
...
@include('catering-backend::balance.includes.script')